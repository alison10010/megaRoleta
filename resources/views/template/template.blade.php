...
<body>
                ...
                <div class="col-12 col-lg-10">
                    <div class="menu_area">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <!-- Logo -->
                            <a class="navbar-brand" href="{{route('lotomania')}}" style="font-size: 40px !important;">Lotomania</a>
    ...
    <section class="awesome-feature-area bg-white section_padding_0_50 clearfix" id="features">
        ...
        <center>
            <button class="btn btn-roxo btn-circle btn-lg" style="margin-bottom: 7px;" onclick="listaRepeticao(10);">10 últimos jogos</button>
            <button class="btn btn-roxo btn-circle btn-lg" style="margin-bottom: 7px" onclick="listaRepeticao(20);">20 últimos jogos</button>
            <button class="btn btn-roxo btn-circle btn-lg" style="margin-bottom: 7px" onclick="listaRepeticao(30);">30 últimos jogos</button>
            <button class="btn btn-roxo btn-circle btn-lg" style="margin-bottom: 7px" onclick="listaRepeticao(40);">40 últimos jogos</button>
            <button class="btn btn-roxo btn-circle btn-lg" style="margin-bottom: 7px" onclick="listaRepeticao(50);">50 últimos jogos</button>
        </center>
        <br />
            <div class="row">
    ...
    <script src="function/lotomania.js"></script>

    <script src="function/api_lotomania.js"></script>

    <script src="function/ultimosJogosLotomania.js"></script>
</body>
