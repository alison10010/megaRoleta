@extends('template.template_lotofacil')  {{-- USA O LAYOUT PADRÃO --}}
...
<section class="special-area bg-white section_padding_100" id="about">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12">
                <div class="single-special text-center wow fadeInUp" style="height: 17rem;" data-wow-delay="0.2s">
    ...
    <br />
    <div class="form-inline" style="justify-content: center;" id="adsLotofacilCorpo">
